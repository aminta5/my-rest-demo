package com.example.mavenDemoRest.bootstrapData;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<User> getUsers() {
        ...
        // first user
        User user1 = new User("John", "Smith", "Jonny", "user@semanticsquate.com","pass", UserType.ADMIN);
        ...
        //second user
        User user2 = new User("Mickey", "Mouse", "Miki", "miki@myemail.com","pass", UserType.USER);
        ...
        //third user
        User user3 = new User("Petko", "Petkoski", "Pepi", "pepi@globalmail.com","pass", UserType.USER);
        ...
        //fourth user
        User user4 = new User("Sheldon", "Cooper", "Shelly", "atom@yellow.com","pass", UserType.USER);
        ...
        //fifth user
        User user5 = new User("Denise", "Menice", "Budd", "buddy@space.com","pass", UserType.USER);
